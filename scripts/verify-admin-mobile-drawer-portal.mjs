...
assertContains("desktop sidebar is conditional for desktop viewport", layout, "!isMobileShell ? <AdminSidebarV2 variant=\"desktop\"");
assertContains("mobile overlay includes the sole portalled sidebar", layout, "<AdminSidebarV2 variant=\"mobile\" mobileOpen={true}");
