...
export default function SiteSettings() {
  ...
  const [formData, setFormData] = useState({
    ...
    primaryColor: settings?.primaryColor || "#4C7DDA",
    secondaryColor: settings?.secondaryColor || "#E2C766",
    backgroundColor: settings?.backgroundColor || "#0B1220",
    textColor: settings?.textColor || "#F9FAFB",
    accentColor: settings?.accentColor || "#B22222",
  ...
  const applyThemePreset = (themeName: string) => {
    ...
    if (!theme) {
      alert("الثيم المطلوب غير موجود: " + themeName);
      return;
    }
    ...
    // تطبيق فوري (نفس منطق ThemeSelector)
              ...
              <CardHeader>
                <CardTitle className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Button
                      size="sm"
                      onClick={() => applyThemePreset("ministry-classic")}
                      className="gap-2"
                      title="تطبيق الهوية الرسمية (أزرق داكن + ذهبي + أخضر خدمات)"
                    >
                      تطبيق هوية الوزارة
                    </Button>
                    <Button
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => applyThemePreset("islamic-light")}
                      className="gap-2"
                      title="أخضر/ذهبي — ثيم إسلامي"
                    >
                      ثيم إسلامي
                    </Button>
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => applyThemePreset("islamic-dark")}
                      className="gap-2"
                      title="ثيم إسلامي داكن"
                    >
                      إسلامي داكن
                    </Button>
                  </div>
                ...
                <CardDescription>
                  اختر ثيم جاهز لتطبيقه فورًا على جميع إعدادات الموقع — أو استخدم أزرار التطبيق السريع أعلاه
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ThemeSelector />
