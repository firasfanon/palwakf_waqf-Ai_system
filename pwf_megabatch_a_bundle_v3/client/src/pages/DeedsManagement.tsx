      ...
      <AdminTable
        title={
          <div className="flex items-center gap-3">
            ...
            <span>إدارة الحجج الوقفية</span>
          </div>
        }
        description="إدارة الحجج والوثائق الوقفية التاريخية والمعاصرة"
        headerRight={
          <Button
            className="h-10"
            onClick={() => {
        ...
        empty={!filteredDeeds?.length}
        emptyTitle="لا توجد حجج وقفية"
        emptyDescription="لم يتم العثور على حجج مطابقة."
      >
<Table>
            <TableHeader>
              <TableRow>
