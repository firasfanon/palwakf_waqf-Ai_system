...
{ title: "مساحة العمل المعرفي", href: "/admin/knowledge-workspace", icon: Brain, component: KnowledgeOperationsWorkspace, lifecycle: "operational", dataState: "connected", note: "مساحة يومية موحدة لمسارات المصدر والمرجع والمعرفة والمراجعة دون حوكمة ثقيلة." },
      ...
      { title: "سجل المصادر وحقوق النشر", href: "/admin/source-provenance-rights", icon: Scale, component: SourceProvenanceRightsRegistry, lifecycle: "operational", dataState: "connected", note: "سجل منشأ وحقوق محكوم: يعرض الرابط وتاريخه والمواد المرتبطة؛ تعديلات الرابط والحقوق لا تتاح قبل تطبيق Schema/RPC ووجود صلاحية assistant.source.manage أو سلطة Super Admin." },
      ...
      { title: "عمليات المراجعة البشرية", href: "/admin/knowledge-review-operations", icon: ShieldCheck, component: KnowledgeReviewOperations, lifecycle: "operational", dataState: "connected", note: "مركز تشغيلي محكوم لتسوية مهام التصنيف، توثيق المصدر والاستشهاد، معالجة KB08B، وعقود KB09 دون نشر تلقائي." },
...
{ title: "صندوق مخرجات الأدوات", href: "/admin/tools/output-intake", icon: CheckCircle, component: ToolOutputIntake, lifecycle: "operational", dataState: "connected", note: "فرز يومي لمخرجات الأدوات القابلة للمراجعة دون تحويل تلقائي إلى معرفة." },
