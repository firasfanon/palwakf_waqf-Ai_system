...
assertContains("sidebar search has a stable id", sidebar, 'id="admin-sidebar-search"');
assertContains("sidebar search has a stable name", sidebar, 'name="admin-sidebar-search"');
